...
\item Caso induttivo
	...
	%\item ciclo while: Assumiamo un programma della forma:
	%$begin\ while\ X_i\ ≠\ X_j\ do\ P\ end$ dove P é un programma per il quale, da ipotesi induttiva, abbiamo una TM M equivalente. Possiamo costruire facilmente una TM $M_{test}$ che rigetta l’input se il valore di $X_i$ e $X_j$ é diverso, ed accetta altrimenti.
	\begin{center}
